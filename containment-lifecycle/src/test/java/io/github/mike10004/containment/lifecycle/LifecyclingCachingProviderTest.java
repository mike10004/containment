...
public class LifecyclingCachingProviderTest {
    ...
    public void provide() {
        ...
        Widget value;
        try (CloseableLifecyclingCachingProvider<Widget> dependency = new CloseableLifecyclingCachingProvider<>(new DecoupledLifecycle<>(commissioner, decommissioner))) {
