 ...
 *     (such as by passing an invalid argument), use the utilities of the {@link com.google.common.base.Preconditions}
 *     class instead.
 *
 ...
 *     {@link #verifyNotNull(Object)} and {@link com.google.common.base.Preconditions#checkNotNull(Object)} perform the
 ...
 *
 * <p>As with {@link com.google.common.base.Preconditions} error message template strings, only the {@code "%s"} specifier
